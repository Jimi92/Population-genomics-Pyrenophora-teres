...
cp /home/taliadoros/Desktop/phd_projects/Ptt/New_full/Newest/MSMC2/vcf_from_bam2/pops/chr1/generate_multihetsep.py ./
cp/home/taliadoros/Desktop/phd_projects/Ptt/New_full/Newest/MSMC2/vcf_from_bam2/pops/chr1/msmc2 ./
> list_of_files.txt
for y in $(ls *.bed.gz)
do
echo "--mask" | tr "\n" " " >> list_of_files.txt
