...
```{r echo=FALSE}
chr1R <- read.table("RAiSD_Report.France_Chr1.out", skip = 1, header = FALSE)
colnames(chr1R) <- c("Position","Start", "End","Diversity","SFS","LD","MU")
chr2R <- read.table("RAiSD_Report.France_Chr2.out", skip = 1, header = FALSE)
colnames(chr2R) <- c("Position","Start", "End","Diversity","SFS","LD","MU")
chr3R <- read.table("RAiSD_Report.France_Chr3.out", skip = 1, header = FALSE)
colnames(chr3R) <- c("Position","Start", "End","Diversity","SFS","LD","MU")
chr4R <- read.table("RAiSD_Report.France_Chr4.out", skip = 1, header = FALSE)
colnames(chr4R) <- c("Position","Start", "End","Diversity","SFS","LD","MU")
chr5R <- read.table("RAiSD_Report.France_Chr5.out", skip = 1, header = FALSE)
colnames(chr5R) <- c("Position","Start", "End","Diversity","SFS","LD","MU")
chr6R <- read.table("RAiSD_Report.France_Chr6.out", skip = 1, header = FALSE)
colnames(chr6R) <- c("Position","Start", "End","Diversity","SFS","LD","MU")
chr7R <- read.table("RAiSD_Report.France_Chr7.out", skip = 1, header = FALSE)
colnames(chr7R) <- c("Position","Start", "End","Diversity","SFS","LD","MU")
chr8R <- read.table("RAiSD_Report.France_Chr8.out", skip = 1, header = FALSE)
colnames(chr8R) <- c("Position","Start", "End","Diversity","SFS","LD","MU")
chr9R <- read.table("RAiSD_Report.France_Chr9.out", skip = 1, header = FALSE)
colnames(chr9R) <- c("Position","Start", "End","Diversity","SFS","LD","MU")
chr10R <- read.table("RAiSD_Report.France_Chr10.out", skip = 1, header = FALSE)
colnames(chr10R) <- c("Position","Start", "End","Diversity","SFS","LD","MU")
chr11R <- read.table("RAiSD_Report.France_Chr11.out", skip = 1, header = FALSE)
colnames(chr11R) <- c("Position","Start", "End","Diversity","SFS","LD","MU")
chr12R <- read.table("RAiSD_Report.France_Chr12.out", skip = 1, header = FALSE)
...
```{r echo=FALSE}
#chr1
ggplot(chr1R,aes(Position,MU)) + geom_point() + geom_hline(yintercept = 211.9, colour = "red") + ggtitle("                                               Chromosome 1") + theme_minimal()
...
#chr2
ggplot(chr2R,aes(Position,MU)) + geom_point() + geom_hline(yintercept = 211.9, colour = "red") + labs(title = "                                               Chromosome 2") + theme_minimal()
...
#chr3
ggplot(chr3R,aes(Position,MU)) + geom_point() + geom_hline(yintercept = 211.9, colour = "red") + labs(title = "                                               Chromosome 3") + theme_minimal()
...
#chr4
ggplot(chr4R,aes(Position,MU)) + geom_point() + geom_hline(yintercept = 211.9, colour = "red") + labs(title = "                                               Chromosome 4") + theme_minimal()
...
#chr5
ggplot(chr5R,aes(Position,MU)) + geom_point() + geom_hline(yintercept = 211.9, colour = "red") + labs(title = "                                               Chromosome 5") + theme_minimal()
...
#chr6
ggplot(chr6R,aes(Position,MU)) + geom_point() + geom_hline(yintercept = 211.9, colour = "red") + labs(title = "                                               Chromosome 6") + theme_minimal()
...
#chr7
ggplot(chr7R,aes(Position,MU)) + geom_point() + geom_hline(yintercept = 211.9, colour = "red") + labs(title = "                                               Chromosome 7") + theme_minimal()
...
#chr8
ggplot(chr8R,aes(Position,MU)) + geom_point() + geom_hline(yintercept = 211.9, colour = "red") + labs(title = "                                               Chromosome 8") + theme_minimal()
...
#chr9
ggplot(chr9R,aes(Position,MU)) + geom_point() + geom_hline(yintercept = 211.9, colour = "red") + labs(title = "                                               Chromosome 9") + theme_minimal()
...
#chr10
ggplot(chr10R,aes(Position,MU)) + geom_point() + geom_hline(yintercept = 211.9, colour = "red") + labs(title = "                                               Chromosome 10") + theme_minimal()
...
#chr11
ggplot(chr11R,aes(Position,MU)) + geom_point() + geom_hline(yintercept = 211.9, colour = "red") + labs(title = "                                               Chromosome 11") + theme_minimal()

#chr12
ggplot(chr12R,aes(Position,MU)) + geom_point() + geom_hline(yintercept = 211.9, colour = "red") + labs(title = "                                               Chromosome 12") + theme_minimal()
...
R_ch1_sign <- chr1R[(as.numeric(chr1R$MU)) >= 211.9, ]
R_ch2_sign <- chr2R[(as.numeric(chr2R$MU)) >= 211.9, ]
R_ch3_sign <- chr3R[(as.numeric(chr3R$MU)) >= 211.9, ]
R_ch4_sign <- chr4R[(as.numeric(chr4R$MU)) >= 211.9, ]
R_ch5_sign <- chr5R[(as.numeric(chr5R$MU)) >= 211.9, ]
R_ch6_sign <- chr6R[(as.numeric(chr6R$MU)) >= 211.9, ]
R_ch7_sign <- chr7R[(as.numeric(chr7R$MU)) >= 211.9, ]
R_ch8_sign <- chr8R[(as.numeric(chr8R$MU)) >= 211.9, ]
R_ch9_sign <- chr9R[(as.numeric(chr9R$MU)) >= 211.9, ]
R_ch10_sign <- chr10R[(as.numeric(chr10R$MU)) >= 211.9, ]
R_ch11_sign <- chr11R[(as.numeric(chr11R$MU)) >= 211.9, ]
R_ch12_sign <- chr12R[(as.numeric(chr12R$MU)) >= 211.9, ]
